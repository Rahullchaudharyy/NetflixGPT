...
const Title = ({title,overview}) => {
  return (
    ...
    <div className='flex gap-4'>
        <button className='bg-white hover:bg-opacity-15 text-2xl px-7 py-3  text-black hover:text-white font-bold rounded-md'> ▸ Play</button>
        <button className='bg-white bg-opacity-50 text-2xl px-7 py-3  text-white font-bold rounded-md'>! More info</button>
    </div>
      </div>
